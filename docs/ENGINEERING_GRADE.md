...
| Operations and deployment | 10% | 3.5/10 | 9.5/10 | Exact v0.2.0 commit `b60e311c53ff0111a2b2ade22d8d96c51e61042f` is installed from a checksummed wheel on the cloud computer. Two network-isolated systemd runs were byte-identical; the service scored **2.1 OK** and remains disabled/inactive with rollback preserved. Authenticated paper and service-manager recovery for that path remain open.[3] [6] |
