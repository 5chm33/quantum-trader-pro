...
[![Coverage](https://img.shields.io/badge/coverage-90.14%25-brightgreen)](tests)
...
| `src/quantum_trader/adapters/` | CSV replay, simulation, fixed-origin paper/control-data clients, strict credential files, and hardened SQLite stores including the immutable experiment ledger |
...
| `docs/` | Architecture, methodology, strategy governance, hypothesis evidence, immutable experiment ledger, failure injection, operator controls, legacy audit, deployment, and visual evidence |
