...
[![Coverage](https://img.shields.io/badge/coverage-90.02%25-brightgreen)](tests)
...
| Path | Responsibility |
|---|---|
| `src/quantum_trader/domain/` | Immutable models, equity forecasts, factor-aware portfolio construction, options contracts/lifecycle accounting, strategy, risk, execution, market controls, approvals, and request budgets |
...
| `docs/` | Architecture, methodology, strategy governance, hypothesis evidence, immutable experiment ledger, point-in-time reference ingestion, forecast-signal, portfolio-construction, and options-lifecycle contracts, failure injection, operator controls, legacy audit, deployment, and visual evidence |
