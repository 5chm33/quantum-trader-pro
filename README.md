...
[![Coverage](https://img.shields.io/badge/coverage-90.77%25-brightgreen)](tests)
...
| Path | Responsibility |
|---|---|
| `src/quantum_trader/domain/` | Immutable models, equity forecasts, factor-aware portfolio construction, research-only execution-cost/capacity, dependence-aware inference, and preregistration estimates, options contracts/lifecycle accounting, strategy, risk, execution, market controls, approvals, and request budgets |
...
| `docs/` | Architecture, methodology, strategy governance, hypothesis evidence, immutable experiment ledger, point-in-time reference ingestion, forecast-signal, portfolio-construction, execution-cost, inference-and-robustness, preregistration, Phase 13 equity/ETF and Phase 14 options data-readiness, provisional equity falsification and independent diagnostics, and options-lifecycle contracts, failure injection, operator controls, legacy audit, deployment, and visual evidence |
...
| `research/examples/` | Synthetic no-network provider-admission inspection example; it is a schema demonstration, not market data or campaign evidence |
