...
def _preflight() -> int:
    ...
    payload = {
        ...
        "paper_arming_contracts": True,
        "external_broker_contracts": True,
        "paper_secure_credential_files": True,
        "operator_store_default_paused": True,
        "operator_one_use_approvals": True,
        "cancel_owned_orders_kill_switch": True,
        "crash_safe_paper_executor": True,
        "no_blind_retry_recovery": True,
        "deterministic_failure_injection": True,
        "literal_process_crash_acceptance": True,
        "simulated_storage_exhaustion_acceptance": True,
        "service_manager_restart_acceptance": False,
        "flatten_positions_kill_switch": False,
        "operator_paper_commands_available": False,
        "authenticated_paper_acceptance": False,
